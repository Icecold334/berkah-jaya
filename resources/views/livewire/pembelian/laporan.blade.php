        ...
        <div class="overflow-x-auto">
           ...
           checked:border-primary-600 checked:bg-primary-600 hover:border-primary-500" />
                        ...
                        <td class="px-4 py-2 relative">
                            @if ($pb->is_lunas)
                            <span class="bg-success-100 text-success-800 text-xs font-semibold px-2.5 py-0.5 rounded">
                                Lunas
                            </span>
                            @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <button type="button" wire:click="togglePajak" @disabled(empty($form['supplier_id']))
                            @class([ 'w-full font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md transition'
                            , $form['kena_pajak']
