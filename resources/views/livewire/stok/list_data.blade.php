            ...
            <tbody>
              ...
              <tr class="border-b">
                ...
                <td class="px-4 py-2">
                  ...
                  <span class="bg-success-100 text-success-800 text-xs font-medium px-2.5 py-0.5 rounded">Pajak</span>
                  @else
                  <span class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded">Non Pajak</span>
                  @endif
                  @else
              ...
              @empty
              <tr>
                <td colspan="6" class="py-4 text-gray-500 text-center">Belum ada pergerakan</td>
              </tr>
              @endforelse
            </tbody>
          </table>
