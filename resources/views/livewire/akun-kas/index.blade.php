<div>
    <div class="">
        <div class="grid grid-cols-2 mb-6">
            <input type="text" wire:model.live="search" placeholder="Cari akun kas..."
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-center text-gray-900">
                ...
                <tbody>
                    @forelse($akunKas as $i => $akun)
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                        <td class="px-6 py-4">{{ $akunKas->firstItem() + $i }}</td>
                        <td class="px-6 py-4 text-left font-medium">{{ $akun->nama }}</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                <!-- Tombol Edit -->
                                <button wire:click="openModal({{ $akun->id }})"
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="py-4">Tidak ada data akun kas</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div x-show="open"
                ...
                <div class="bg-white rounded-md p-6 w-1/3">
                    <h2 class="text-xl font-semibold mb-4">
                        {{ $akunKasId ? 'Edit Akun Kas' : 'Tambah Akun Kas' }}
                    </h2>
