                    ...
                    @forelse($transaksiKas as $tk)
                        <tr class="odd:bg-white even:bg-gray-50 border-b">
                            ...
                            <td class="px-4 py-2">
                                @if ($tk->tipe === 'masuk')
                                    <span
                                        class="bg-success-100 text-success-800 text-xs font-medium px-2.5 py-0.5 rounded">
                                        Masuk
                                    </span>
                                @else
                                    <span
                                        class="bg-danger-100 text-danger-800 text-xs font-medium px-2.5 py-0.5 rounded">
                                        Keluar
                                    </span>
                                @endif
                            </td>
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model.live="form.kategori_id" @disabled(empty($form['tipe']))
                                class="w-full text-sm rounded border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200
