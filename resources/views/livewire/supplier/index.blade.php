        ...
        <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
          ...
          <td class="px-6 py-4 text-center space-x-2">
            <button wire:click="openModal({{ $supplier->id }})"
              class="bg-info-100 text-info-800 text-sm font-medium px-2.5 py-1 rounded-sm">
      ...
      <div class="bg-white rounded-md p-6 w-1/3">
        ...
        <form wire:submit.prevent="save">
          <div class="mb-3">
            ...
            @error('nama') <span class="text-danger-600 text-sm">{{ $message }}</span> @enderror
          </div>
          <div class="mb-3">
          ...
          <div class="text-right">
            <button type="button" @click="open=false" class="bg-gray-300 px-4 py-2 rounded-md">Batal</button>
